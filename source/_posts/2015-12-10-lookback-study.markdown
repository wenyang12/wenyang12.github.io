...
![测试图]({{ url_root }}/images/loopback-pic-1.png)
...
![测试图]({{ url_root }}/images/loopback-pic-2.png)

点击`Try it out！` 按钮，注册成功会返回状态码200，如图：

![测试图]({{ url_root }}/images/loopback-pic-2-1.png)

**登录测试**

在页面中打开`/users/login` 登录，如图：

![测试图]({{ url_root }}/images/loopback-pic-3.png)

点击`Try it out！` 按钮，登录成功会返回状态码200，如图：

![测试图]({{ url_root }}/images/loopback-pic-3-1.png)
